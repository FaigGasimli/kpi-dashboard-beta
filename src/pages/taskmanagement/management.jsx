...
const TaskManagement = () => {
  ...
  const [tasks, setTasks] = useState({
    "Kompliyens Monitoring": [
      {
        id: 1,
        name: "Yüksək risli müştərilərin kvar...",
        workProcess: "AML Monitoring",
        workProcedure: "Risk Assessment",
        weightDegree: "10",
      ...
      {
        id: 2,
        name: "Yeni qeydli hesablar üzrə CDD...",
        workProcess: "Customer Due Diligence",
        workProcedure: "Account Opening",
        weightDegree: "3",
      ...
      {
        id: 3,
        name: "AML daxili təlim planının hazır...",
        workProcess: "Training & Development",
        workProcedure: "Internal Training",
        weightDegree: "7",
    ...
    "BL / TMM": [
      {
        id: 4,
        name: "Yüksək risli müştərilərin kvar...",
        workProcess: "Business Line Management",
        workProcedure: "Client Management",
        weightDegree: "8",
        executor: "Səbinə Quliyeva",
        creator: "BL Rəhbəri",
        createdDate: "05 İyul 2025",
        deadline: "05 İyul 2025",
        status: "Tamamlanmış",
        ...
        <div className={styles.tableSection}>
          <div className={styles.tableHeader}>
            ...
            <div className={styles.tableActions}>
              ...
              <button className={styles.filterButton}>Təmiz göra filtr</button>
              ...
              {expandedDepartments[deptName] && (
                <div className={styles.taskTable}>
                  <div className={styles.tableHeaderRow}>
                    ...
                    <div className={styles.tableHeaderCell}>Yaranma tarixi</div>
                    <div className={styles.tableHeaderCell}>
                      Deadline tarixi
                    </div>
                  ...
                  {departmentTasks.map((task) => (
                    ...
                    >
                      ...
                      <div className={styles.tableCell}>{task.workProcess}</div>
                      ...
                      <div className={styles.tableCell}>{task.createdDate}</div>
